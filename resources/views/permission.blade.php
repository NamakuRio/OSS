                        ...
                        <div class="card-header">
                            ...
                            @can ('permission.create')
                                <div class="card-header-action">
                                    <a href="javascript:void(0)" class="btn btn-primary" onclick="$('#modal-add-permission').modal('show');focusable('#add-role-name', 500);" tooltip="Tambah Izin"><i class="fas fa-plus"></i> Tambah Izin</a>
                                </div>
                            @endcan
                        </div>
                        <div class="card-body">
